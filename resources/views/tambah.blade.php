...
@section('content')
  ...
  <div class="flex flex-wrap -mx-3 mb-6">
    <div class="w-72 px-3 mb-6 md:mb-0">
      <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-first-name">
        Nama
      </label>
      <input required class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" type="text" name="name" class="form-control" id="exampleInputEmail1" placeholder="Jane">
    </div>
    <div class="w-50 px-3 mb-6 md:mb-0">
      <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="grid-first-name">
        Nisn
      </label>
      <input required class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" type="text" name="nisn" class="form-control" id="exampleInputEmail1" placeholder="1234">
    </div>
  </div>
  ...
  <div class="flex flex-wrap -mx-3 mb-2">
    ...
    <div class="w-full md:w-1/3 px-3 mb-6 md:mb-0">
        ...
        <div class="relative">
            <select class="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" class="form-control"  class="form-control"  name="keahlian"  id="exampleFormControlSelect1">
